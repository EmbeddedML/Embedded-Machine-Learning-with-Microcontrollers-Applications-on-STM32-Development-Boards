...
int main(void)
{
  ...
  LIB_IMAGE_InitStruct(&cropped, (uint8_t*)pImageCropped, 28, 28, IMAGE_FORMAT_RGB565);
  LIB_IMAGE_InitStruct(&croppedGray, (uint8_t*)pImageCroppedGray, 28, 28, IMAGE_FORMAT_GRAYSCALE);
  LIB_SW_Init(&sw);
  BSP_SDRAM_Init();
