...
kws_cnn_model.compile(optimizer = optimizers.Adam(0.0005, weight_decay = 1e-6),
                      loss = losses.SparseCategoricalCrossentropy(),
                       metrics="accuracy")
model_cp_callback = ModelCheckpoint(os.path.join(KERAS_MODEL_DIR, "kws_cnn.h5"),save_best_only=True)
