...
tensorflow/lite/kernels/%.o: ../tensorflow/lite/kernels/%.cc tensorflow/lite/kernels/subdir.mk
...
clean-tensorflow-2f-lite-2f-kernels:
	-$(RM) ./tensorflow/lite/kernels/kernel_util.d ./tensorflow/lite/kernels/kernel_util.o
