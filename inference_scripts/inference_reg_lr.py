...
line_model_path = osp.join("regression_models","linear_line_reg.joblib")
sine_model_path = osp.join("regression_models","linear_sine_reg.joblib")
line_export_path = osp.join("exported_models","regression","lin_reg_config")

line_linear_model = LinearRegressor.load(line_model_path)
sine_linear_model = LinearRegressor.load(sine_model_path)
