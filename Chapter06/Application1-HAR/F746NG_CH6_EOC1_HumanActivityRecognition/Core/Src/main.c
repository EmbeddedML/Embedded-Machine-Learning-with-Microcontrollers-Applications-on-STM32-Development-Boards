...
arm_matrix_instance_f32 mat_input = {.numCols = 1, .numRows= NUM_FEATURES, .pData=(float*)&features};
arm_matrix_instance_f32 mat_output = {.numCols = NUM_CLASSES, .numRows=1, .pData=output};
